      ...
      <div className="space-y-6">
        ...
        <Card id="introduccion">
          ...
          <CardContent className="px-4">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              gestionar sus propias reservas. El sistema está diseñado para ser
          ...
          <CardContent className="px-4 space-y-6">
            ...
            <div id="crear-cuenta">
              ...
              <ol className="list-decimal pl-5 space-y-2 mb-4">
                <li>
                  ...
                  <span className="font-medium">Iniciar Sesión</span> en la
                ...
                <li>
                  ...
                  <ul className="list-disc pl-5 mt-2 space-y-1 text-sm">
                    <li>
                      <span className="font-medium">Nombre completo:</span> Su
                      nombre y apellido.
                    </li>
                    <li>
                      ...
                      Seleccione su número de apartamento (1-48).
                    </li>
                    <li>
                    ...
                    <li>
                      <span className="font-medium">Contraseña:</span> Cree una
                      contraseña segura (mínimo 8 caracteres).
                    </li>
                    <li>
                      <span className="font-medium">Confirmar contraseña:</span>{" "}
                      Repita la contraseña creada.
                    </li>
                  </ul>
                </li>
                <li>
                  Haga clic en <span className="font-medium">Crear Cuenta</span>{" "}
            ...
            <div id="iniciar-sesion">
              ...
              <p className="text-sm text-muted-foreground">
                Una vez iniciada la sesión, será redirigido a la página
                principal de reservas donde podrá ver y gestionar sus reservas.
              </p>
            </div>
            ...
            <div id="recuperar-contraseña">
              ...
              <p className="text-muted-foreground mb-3">
                Si ha olvidado su contraseña, puede restablecerla siguiendo
                estos pasos:
              </p>
              <ol className="list-decimal pl-5 space-y-2 mb-4">
                <li>
                  En la pantalla de inicio de sesión, haga clic en{" "}
                  <span className="font-medium">¿Olvidó su contraseña?</span>.
                </li>
                <li>Ingrese el correo electrónico asociado a su cuenta.</li>
                <li>
                  Haga clic en{" "}
                  <span className="font-medium">Enviar Instrucciones</span>.
                </li>
                <li>
                  Recibirá un correo electrónico con un enlace para restablecer
                  su contraseña (revise su carpeta de spam si no lo recibe).
                </li>
                <li>
                  Haga clic en el enlace y siga las instrucciones para crear una
                  nueva contraseña.
                </li>
              </ol>
            ...
            <div id="perfil">
              ...
              <ol className="list-decimal pl-5 space-y-2 mb-4">
                <li>
                  Haga clic en su nombre o iniciales en la parte superior
                  derecha.
                </li>
                <li>
                  Seleccione <span className="font-medium">Perfil</span> en el
                  menú desplegable.
                </li>
                <li>
                ...
                <li>
                  Haga clic en{" "}
                  <span className="font-medium">Guardar Cambios</span> para
                  actualizar su información.
                </li>
              </ol>
              <p className="text-sm text-muted-foreground">
                El correo electrónico no se puede cambiar ya que es el
                identificador principal de su cuenta. Si necesita cambiar su
                correo electrónico, contacte con el administrador del sistema.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card id="reservas">
          ...
          <CardContent className="px-4 space-y-6">
            ...
            <div id="crear-reserva">
              ...
              <ol className="list-decimal pl-5 space-y-2 mb-4">
                <li>
                  Desde la página principal, haga clic en el botón{" "}
                  <span className="font-medium">Nueva Reserva</span>.
                </li>
                <li>
                  Seleccione la fecha deseada para su reserva en el calendario.
                </li>
                <li>
                  Elija el tipo de comida:{" "}
                  <span className="font-medium">Comida</span> o{" "}
                  <span className="font-medium">Cena</span>.
                </li>
                <li>Indique el número de personas que asistirán.</li>
                <li>
                  Seleccione las mesas que desea reservar (1-6) haciendo clic en
                  ellas en el diagrama:
                  <ul className="list-disc pl-5 mt-2 space-y-1 text-sm">
                    <li>Las mesas disponibles aparecen en color naranja.</li>
                    <li>
                      Las mesas ya reservadas aparecen en gris y no pueden
                      seleccionarse.
                    </li>
                    <li>
                      Las mesas seleccionadas se mostrarán en color primario
                      (azul).
                    </li>
                  </ul>
                </li>
                <li>
                  Marque las opciones adicionales si las necesita:
                  <ul className="list-disc pl-5 mt-2 space-y-1 text-sm">
                    <li>
                      <span className="font-medium">
                        Preparar fuego para la reserva
                      </span>
                      : Si necesita que se prepare el fuego.
                    </li>
                    <li>
                ...
                <li>
                  Haga clic en{" "}
                  <span className="font-medium">Crear Reserva</span> para
                  finalizar.
                </li>
              </ol>
              <div className="bg-blue-50 p-3 rounded-md text-sm text-blue-700">
            ...
            <div id="gestionar-reservas">
              ...
              <p className="text-muted-foreground mb-3">
                Para modificar o cancelar sus reservas existentes:
              </p>
              ...
              <ol className="list-decimal pl-5 space-y-1 mb-4">
                ...
                <li>
                  Haga clic en{" "}
                  <span className="font-medium">Actualizar Reserva</span> para
                  guardar los cambios.
                </li>
              </ol>
        ...
        <Card id="visualizacion">
          ...
          <CardContent className="px-4 space-y-4">
            ...
            <p className="text-muted-foreground mb-3">
              La aplicación ofrece varias opciones para filtrar y visualizar sus
              reservas:
            </p>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <span className="font-medium">Hoy:</span> Muestra solo las
                reservas del día actual.
              </li>
              <li>
                <span className="font-medium">Próximas:</span> Muestra todas las
                reservas futuras, incluyendo las de hoy.
              </li>
              <li>
              ...
              <li>
                ...
                seleccionar una fecha en el calendario, se muestran solo las
                reservas para ese día.
              </li>
            </ul>

            <h3 className="font-medium text-base mb-2 mt-6">
            ...
            <p className="text-muted-foreground mt-3">
              Para cambiar entre estas vistas, utilice el botón de alternar
              vista (con ícono de cuadrícula o lista) ubicado junto al título de
            ...
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>
                Debajo del calendario, utilice las pestañas{" "}
                <span className="font-medium">Comida</span> y{" "}
                <span className="font-medium">Cena</span> para ver la
                disponibilidad para cada servicio.
              </li>
              <li>
              ...
              <li>
                Si todas las mesas están reservadas, aparecerá un mensaje
                indicándolo.
              </li>
            </ol>
          </CardContent>
        ...
        <Card id="servicios-adicionales">
          ...
          <CardContent className="px-4">
            <p className="text-muted-foreground mb-3">
              Al crear o editar una reserva, puede solicitar estos servicios
              adicionales:
            </p>
            <ul className="list-disc pl-5 space-y-3">
              <li>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Solicite que se prepare el fuego para su reserva. Útil si
                  planea usar la zona de fuego y prefiere encontrarlo ya
                  preparado.
                </p>
              </li>
              <li>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Solicita el uso exclusivo del horno comunitario para su comida
                  o cena. Recomendado si planea cocinar alimentos que requieren
                  horno.
                </p>
              </li>
        ...
        <Card id="actividad">
          ...
          <CardContent className="px-4 space-y-4">
            <p className="text-muted-foreground mb-3">
              El sistema mantiene un registro completo de todas las actividades
            ...
            <ol className="list-decimal pl-5 space-y-2">
              <li>
                Haga clic en el botón{" "}
                <span className="font-medium">Ver Actividad</span> en la página
                principal.
              </li>
              <li>
                En la página de actividad, podrá ver un historial cronológico de
                todas las acciones relacionadas con las reservas de su
                apartamento.
              </li>
              <li>
                Utilice los controles de paginación en la parte inferior para
